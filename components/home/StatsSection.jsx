...
const StatsSection = () => {
  const stats = [
    // { icon: DollarSign, value: "$50M+", label: "Revenue Generated", desc: "Payouts distributed this year", color: "blue" },
    {
      ...
      desc: "Trusted publishers worldwide",
      color: "purple",
    },
    {
      icon: Clock,
      value: "98%",
      label: "Uptime",
      desc: "Reliable platform availability 24/7",
      color: "emerald",
    },
    {
      icon: Globe,
            ...
            {stats.map((stat, idx) => (
              ...
              >
                ...
                <div className="relative w-14 h-14 mb-4 flex items-center justify-center">
                  <div
                    className={`absolute inset-0 bg-${stat.color}-100 rounded-2xl rotate-6 opacity-60`}
                  ></div>
                  <div
                    className={`relative bg-white p-3 rounded-2xl shadow-sm border border-${stat.color}-50`}
                  >
                ...
                <p className="text-gray-500 text-sm leading-snug max-w-[160px]">
                  {stat.desc}
                </p>
              </div>
            ))}
